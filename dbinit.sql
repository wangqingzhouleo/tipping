...
-- Table `tipping`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tipping`.`users` (
  ...
  `sex` ENUM('F', 'M', 'DK') NOT NULL DEFAULT 'DK',
  ...
  `reset-pass-token-expired` BIGINT(20) NULL,
  PRIMARY KEY (`uid`, `roles`),
...
-- -----------------------------------------------------
-- Table `tipping`.`game-team`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tipping`.`game-team` (
  ...
  INDEX `fk_game-team_1_idx` (`type` ASC),
  CONSTRAINT `fk_game-team_1`
    FOREIGN KEY (`type`)
...
CREATE TABLE IF NOT EXISTS `tipping`.`game` (
  ...
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk_game_2_idx` (`team1` ASC),
  INDEX `fk_game_2_idx1` (`team2` ASC),
  ...
  CONSTRAINT ``
    FOREIGN KEY (`team1`)
    REFERENCES `tipping`.`game-team` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
